...
class MyFrame(ctk.CTkFrame):
    def __init__(self, master):
        ...
        # Buttons in column 0
        self.btnAC = ctk.CTkButton(self, text="AC", font=("Roboto", 30), corner_radius=100, width=0, height=40,
                                   fg_color="#808080", text_color="black", border_color="black", border_width=1,
                                   hover_color="#a6a6a6",
                                   command=lambda: self.btn_AC())
        self.btn7 = ctk.CTkButton(self, text="7", font=("Roboto", 30), corner_radius=100, width=0, height=40,
                                  fg_color="#424242", text_color="white", border_color="black", border_width=1,
                                  hover_color="#666666",
                                  command=lambda: self.btn_click(self.btn7.cget("text")))
        self.btn4 = ctk.CTkButton(self, text="4", font=("Roboto", 30), corner_radius=100, width=0, height=40,
                                  fg_color="#424242", text_color="white", border_color="black", border_width=1,
                                  hover_color="#666666",
                                  command=lambda: self.btn_click(self.btn4.cget("text")))
        self.btn1 = ctk.CTkButton(self, text="1", font=("Roboto", 30), corner_radius=100, width=0, height=40,
                                  fg_color="#424242", text_color="white", border_color="black", border_width=1,
                                  hover_color="#666666",
                                  command=lambda: self.btn_click(self.btn1.cget("text")))
        self.btn0 = ctk.CTkButton(self, text="0", font=("Roboto", 30), corner_radius=100, width=0, height=40,
                                  fg_color="#424242", text_color="white", border_color="black", border_width=1,
                                  hover_color="#666666",
                                  command=lambda: self.btn_click(self.btn0.cget("text")))

        # Buttons in column 1
        self.btnneg = ctk.CTkButton(self, text="±", font=("Roboto", 30), corner_radius=100, width=80, height=40,
                                    fg_color="#808080", text_color="black", border_color="black", border_width=1,
                                    hover_color="#a6a6a6",
                                    command=lambda: self.btn_neg())
        self.btn8 = ctk.CTkButton(self, text="8", font=("Roboto", 30), corner_radius=100, width=60, height=40,
                                  fg_color="#424242", text_color="white", border_color="black", border_width=1,
                                  hover_color="#666666",
                                  command=lambda: self.btn_click(self.btn8.cget("text")))
        self.btn5 = ctk.CTkButton(self, text="5", font=("Roboto", 30), corner_radius=100, width=60, height=40,
                                  fg_color="#424242", text_color="white", border_color="black", border_width=1,
                                  hover_color="#666666",
                                  command=lambda: self.btn_click(self.btn5.cget("text")))
        self.btn2 = ctk.CTkButton(self, text="2", font=("Roboto", 30), corner_radius=100, width=60, height=40,
                                  fg_color="#424242", text_color="white", border_color="black", border_width=1,
                                  hover_color="#666666",
                                  command=lambda: self.btn_click(self.btn2.cget("text")))

        # Buttons in column 2
        self.btnperc = ctk.CTkButton(self, text="%", font=("Roboto", 30), corner_radius=100, width=80, height=40,
                                     fg_color="#808080", text_color="black", border_color="black", border_width=1,
                                     hover_color="#a6a6a6",
                                     command=lambda: self.btn_perc())
        self.btn9 = ctk.CTkButton(self, text="9", font=("Roboto", 30), corner_radius=100, width=60, height=40,
                                  fg_color="#424242", text_color="white", border_color="black", border_width=1,
                                  hover_color="#666666",
                                  command=lambda: self.btn_click(self.btn9.cget("text")))
        self.btn6 = ctk.CTkButton(self, text="6", font=("Roboto", 30), corner_radius=100, width=60, height=40,
                                  fg_color="#424242", text_color="white", border_color="black", border_width=1,
                                  hover_color="#666666",
                                  command=lambda: self.btn_click(self.btn6.cget("text")))
        self.btn3 = ctk.CTkButton(self, text="3", font=("Roboto", 30), corner_radius=100, width=60, height=40,
                                  fg_color="#424242", text_color="white", border_color="black", border_width=1,
                                  hover_color="#666666",
                                  command=lambda: self.btn_click(self.btn3.cget("text")))
        self.btndot = ctk.CTkButton(self, text=".", font=("Roboto", 30), corner_radius=100, width=60, height=40,
                                    fg_color="#424242", text_color="white", border_color="black", border_width=1,
                                    hover_color="#666666",
                                    command=lambda: self.btn_click(self.btndot.cget("text")))
        self.btnequal = ctk.CTkButton(self, text="=", font=("Roboto", 30), corner_radius=100, width=60, height=40,
                                      fg_color="#e0810d", text_color="white", border_color="black", border_width=1,
                                      hover_color="#f4a23e",
                                      command=lambda: self.btn_equal())

        # Buttons in column 3
        self.btnerase = ctk.CTkButton(self, text="←", font=("Roboto", 30), corner_radius=100, width=80, height=40,
                                      fg_color="#808080", text_color="black", border_color="black", border_width=1,
                                      hover_color="#a6a6a6",
                                      command=lambda: self.btn_erase())
        self.btndivide = ctk.CTkButton(self, text="÷", font=("Roboto", 30), corner_radius=100, width=80, height=40,
                                       fg_color="#e0810d", text_color="white", border_color="black", border_width=1,
                                       hover_color="#f4a23e",
                                       command=lambda: self.btn_click(self.btndivide.cget("text")))
        self.btntimes = ctk.CTkButton(self, text="x", font=("Roboto", 30), corner_radius=100, width=60, height=40,
                                      fg_color="#e0810d", text_color="white", border_color="black", border_width=1,
                                      hover_color="#f4a23e",
                                      command=lambda: self.btn_click(self.btntimes.cget("text")))
        self.btnminus = ctk.CTkButton(self, text="-", font=("Roboto", 30), corner_radius=100, width=60, height=40,
                                      fg_color="#e0810d", text_color="white", border_color="black", border_width=1,
                                      hover_color="#f4a23e",
                                      command=lambda: self.btn_click(self.btnminus.cget("text")))
        self.btnplus = ctk.CTkButton(self, text="+", font=("Roboto", 30), corner_radius=100, width=60, height=40,
                                     fg_color="#e0810d", text_color="white", border_color="black", border_width=1,
                                     hover_color="#f4a23e",
    ...
    def btn_erase(self):
        try:
            self.resLabel.configure(text=(self.resLabel.cget("text")[:-1]))
        except:
            self.resLabel.configure(text="Error", text_color="red")

    def btn_equal(self):
        try:
            self.contaLabel.configure(text=("{}".format(self.resLabel.cget("text"))))
            if "x" or "÷" in self.resLabel.cget("text"):
                self.resLabel.configure(text=("{}".format(eval((self.resLabel.cget("text").replace("x", "*")).replace("÷", "/")))))
            else:
                self.resLabel.configure(text=("{}".format(eval(self.resLabel.cget("text")))))
        except:
            self.resLabel.configure(text="Error", text_color="red")

    def btn_perc(self):
        try:
            self.contaLabel.configure(text=("{}".format("({})÷100".format(self.resLabel.cget("text")))))
            self.resLabel.configure(text=("{}".format(eval("({})/100".format(self.resLabel.cget("text"))))))
        except:
            self.resLabel.configure(text="Error", text_color="red")

    def btn_neg(self):
        try:
            self.resLabel.configure(text="{}".format((-1)*eval((self.resLabel.cget("text")))))
        except:
            self.resLabel.configure(text="Error", text_color="red")
