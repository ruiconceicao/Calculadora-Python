...
class MyButtonFrame(ctk.CTkFrame):
    def __init__(self, master):
        ...
        self.btnAC.grid(row=2, column=0, sticky="new", padx=1, pady=1)
        self.btnNeg.grid(row=2, column=1, sticky="new", padx=1, pady=1)
        self.btnPerc.grid(row=2, column=2, sticky="new", padx=1, pady=1)
        self.btndivide.grid(row=2, column=3, sticky="new", padx=1, pady=1)
        # Buttons configs and positions in row 3
        self.btn7.grid(row=3, column=0, sticky="new", padx=1, pady=1)
        self.btn8.grid(row=3, column=1, sticky="new", padx=1, pady=1)
        self.btn9.grid(row=3, column=2, sticky="new", padx=1, pady=1)
        self.btntimes.grid(row=3, column=3, sticky="new", padx=1, pady=1)
        # Buttons configs and positions in row 4
        self.btn4.grid(row=4, column=0, sticky="new", padx=1, pady=1)
        self.btn5.grid(row=4, column=1, sticky="new", padx=1, pady=1)
        self.btn6.grid(row=4, column=2, sticky="new", padx=1, pady=1)
        self.btnminus.grid(row=4, column=3, sticky="new", padx=1, pady=1)
        # Buttons configs and positions in row 5
        self.btn1.grid(row=5, column=0, sticky="new", padx=1, pady=1)
        self.btn2.grid(row=5, column=1, sticky="new", padx=1, pady=1)
        self.btn3.grid(row=5, column=2, sticky="new", padx=1, pady=1)
        self.btnplus.grid(row=5, column=3, sticky="new", padx=1, pady=1)
        # Buttons configs and positions in row 6
        self.btn0.grid(row=6, column=0, sticky="new", columnspan=2, padx=1, pady=1)
        self.btndot.grid(row=6, column=2, sticky="new", padx=1, pady=1)
        self.btnequal.grid(row=6, column=3, sticky="new", padx=1, pady=1)
